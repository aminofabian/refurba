                ...
                <div className="relative group/category" onClick={handleMainClick}>
                    ...
                    <div 
                        className={`
                            ...
                            ${isActive 
                                ? 'bg-gradient-to-br from-[#294a54] via-[#294a54]/90 to-[#294a54]/80 shadow-[0_0_25px_rgba(41,74,84,0.45)] hover:shadow-[0_0_30px_rgba(41,74,84,0.5)]' 
                                : 'bg-gray-200 group-hover/category:bg-[#657b7c]/20'
                            }
                        `}
                        style={{
                    ...
                    <div 
                        className={`
                            ...
                            ${isActive 
                                ? 'bg-white text-[#294a54] after:absolute after:inset-x-4 after:-bottom-0.5 after:h-[3px] after:bg-[#294a54]/30 after:rounded-full' 
                                : 'bg-white text-[#657b7c] group-hover/category:text-[#294a54] hover:cursor-pointer'
                            }
                            ${isOpen ? 'shadow-[0_0_15px_rgba(41,74,84,0.2)]' : ''}
                            ...
                            before:bg-[radial-gradient(circle_at_30%_107%,rgba(41,74,84,0.08)_0%,rgba(41,74,84,0.04)_5%,rgba(41,74,84,0.02)_45%,rgba(41,74,84,0.04)_60%,rgba(41,74,84,0.08)_90%)]
                        `}
                        style={{
                            clipPath: 'polygon(92% 0, 100% 25%, 100% 100%, 8% 100%, 0% 75%, 0 0)'
                        }}
                    >
                        ...
                        <div 
                            ...
                            `}
                            style={{
                                backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23294a54' fill-opacity='1'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`
                            }}
                        />
                        ...
                        `}>
                            {isActive && (
                                <span className="w-1.5 h-1.5 rounded-full bg-[#294a54] animate-ping absolute -left-3" />
                            )}
                            {category.name}
                            {isActive && (
                                <span className="absolute -right-3 top-1/2 -translate-y-1/2 flex gap-0.5">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[#294a54]/60 animate-pulse" />
                                    <span className="w-1.5 h-1.5 rounded-full bg-[#294a54]/40 animate-pulse delay-75" />
                                </span>
                            )}
                        </span>
                        {hasSubcategories && (
                            ...
                            `}>
                                <div className={`
                                    ...
                                    transition-all duration-300
                                    ${isActive 
                                        ? 'bg-[#294a54] animate-pulse scale-110' 
                                        : 'bg-gray-400 group-hover/category:bg-[#294a54]'
                                    }
                                `} />
                                <ChevronDown className={`
                                    ...
                                    transition-all duration-300
                                    ${isActive 
                                        ? 'text-[#294a54] scale-110' 
                                        : 'text-gray-400 group-hover/category:text-[#294a54]'
                                    }
                                `} />
                            </div>
                        )}
                        ...
                        <div className={`
                            ...
                            transition-all duration-300
                            ${isActive 
                                ? 'border-[#294a54]/50 w-5 h-5 border-t-[3px] border-r-[3px]' 
                                : 'border-gray-300/50 group-hover/category:border-[#294a54]/20'
                            }
                        `} />
                        <div className={`
                            ...
                            transition-all duration-300
                            ${isActive 
                                ? 'border-[#294a54]/50 w-5 h-5 border-b-[3px] border-l-[3px]' 
                                : 'border-gray-300/50 group-hover/category:border-[#294a54]/20'
                            }
                        `} />
                        ...
                        {isActive && (
                            <>
                                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-[2px] w-1.5 h-1.5 bg-[#294a54]/60 rounded-full animate-pulse" />
                                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-[2px] w-1.5 h-1.5 bg-[#294a54]/60 rounded-full animate-pulse" />
                            </>
                        )}
                    </div>
                </div>
            ...
            {hasSubcategories && categorySlug !== 'all' && (
                <DropdownMenuContent 
                    className={`
                        ...
                        ${isActive ? 'border-[#294a54]/30 shadow-[0_4px_25px_-5px_rgba(41,74,84,0.25)]' : ''}
                    `}
                    align="start"
                    sideOffset={8}
                >
                                    ...
                                    <Link href={subcategoryUrl} className="block">
                                        <DropdownMenuItem 
                                            className={`
                                                ...
                                                focus:text-[#294a54] focus:bg-[#294a54]/5
                                                active:bg-[#294a54]/10
                                                ${isSubcategoryActive ? 'bg-[#294a54]/5 text-[#294a54]' : ''}
                                                ${isActive ? 'data-[highlighted]:bg-[#294a54]/5' : 'data-[highlighted]:bg-gray-100'}
